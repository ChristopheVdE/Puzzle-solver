            ...
            for col in [0, 3, 6]:
                for i in range(1, 10):
                    if box(self.solution, (row, col)).count(str(i)) > 1:
                        return True
        for i in range(1,10):
            if Hvalues(self.solution).count(str(i)) > 1:
                return True
        return False
...
# Return a list of all the values from the "H" if the position is part of it -------------------------------
def Hvalues(board):
    # specify the positions that are part of the H
    positions = [(2, 3), (3, 3), (4, 3), (5, 3), (4, 4), (2, 5), (3, 5), (4, 5), (5, 5)]
    # get all values from the "H"
    values = []
...
def valid(board, empty_pos):
    ...
    for value in range(1, 10):
        if empty_pos in [(2, 3), (3, 3), (4, 3), (5, 3), (4, 4), (2, 5), (3, 5), (4, 5), (5, 5)]:
            if (
                ...
                and not str(value) in Hvalues(board)                 # H
            ):
                valid.append(value)
        else:
            if (
            ...
            for value in values:
                if empty_pos in [(2, 3), (3, 3), (4, 3), (5, 3), (4, 4), (2, 5), (3, 5), (4, 5), (5, 5)]:
                    if (
                        ...
                        and not value in Hvalues(board)                 # H
                    ):
